...
export const SKIN_HAIR_SUITABILITY: Record<string, SuitabilityCopy> = {
  ...
  ar: {
    ...
    skinTitle: 'لون البشرة: Fitzpatrick I–V',
    skinBody:
      'مناسب لدرجات البشرة من الفاتحة جدًا إلى البنية — أنواع Fitzpatrick من I إلى V. غير مناسب للنوع VI من Fitzpatrick (البشرة شديدة التصبغ): لا يمكن إيصال الضوء بجرعة آمنة وفعّالة، لذلك لا نوصي باستخدام IPL لهذه الدرجة من البشرة.',
    ...
    imageAlt:
      'مخطط ملاءمة IPL: درجات بشرة Fitzpatrick من I إلى V مناسبة والنوع VI غير مناسب؛ الشعر الأشقر الداكن والبني والأسود مناسب، بينما الشعر الأشقر الفاتح والأحمر والرمادي الفاتح غير مناسب.',
  },
  cs: {
    ...
    skinTitle: 'Tón pleti: Fitzpatrick I–V',
    skinBody:
      'Vhodné pro tóny pleti od velmi světlé po hnědou — typy Fitzpatrick I až V. Nevhodné pro typ Fitzpatrick VI (výrazně pigmentovaná pleť): světlo nelze dodat v bezpečné a účinné dávce, proto IPL pro tento tón pleti nedoporučujeme.',
    ...
    imageAlt:
      'Tabulka vhodnosti IPL: tóny pleti Fitzpatrick I až V jsou vhodné a typ VI nikoli; tmavě blond, hnědé a černé vlasy jsou vhodné, zatímco světle blond, zrzavé a světle šedé vlasy vhodné nejsou.',
  },
  de: {
    ...
    skinTitle: 'Hautton: Fitzpatrick I–V',
    skinBody:
      'Geeignet für Hauttöne von sehr hell bis braun — Fitzpatrick-Typ I bis V. Nicht geeignet für Fitzpatrick-Typ VI (stark pigmentierte Haut): Das Licht lässt sich nicht in einer sicheren, wirksamen Dosis abgeben, daher empfehlen wir IPL für diesen Hautton nicht.',
    ...
    imageAlt:
      'IPL-Eignungstabelle: Fitzpatrick-Hauttöne I bis V sind geeignet, Typ VI nicht; dunkelblondes, braunes und schwarzes Haar ist geeignet, hellblondes, rotes und hellgraues Haar dagegen nicht.',
  },
  el: {
    ...
    skinTitle: 'Τόνος δέρματος: Fitzpatrick I–V',
    skinBody:
      'Κατάλληλο για τόνους δέρματος από πολύ ανοιχτό έως καφέ — τύποι Fitzpatrick I έως V. Δεν είναι κατάλληλο για τον τύπο Fitzpatrick VI (έντονα μελαγχρωματισμένο δέρμα): το φως δεν μπορεί να εφαρμοστεί σε ασφαλή και αποτελεσματική δόση, επομένως δεν συνιστούμε IPL για αυτόν τον τόνο δέρματος.',
    ...
    imageAlt:
      'Πίνακας καταλληλότητας IPL: οι τόνοι δέρματος Fitzpatrick I έως V είναι κατάλληλοι και ο τύπος VI δεν είναι· οι τρίχες σε σκούρο ξανθό, καφέ και μαύρο χρώμα είναι κατάλληλες, ενώ οι τρίχες σε ανοιχτό ξανθό, κόκκινο και ανοιχτό γκρι χρώμα δεν είναι.',
  },
  es: {
    ...
    skinTitle: 'Tono de piel: Fitzpatrick I–V',
    skinBody:
      'Adecuado para tonos de piel desde muy claro hasta moreno — tipos Fitzpatrick I a V. No es adecuado para el tipo Fitzpatrick VI (piel muy pigmentada): la luz no puede aplicarse en una dosis segura y eficaz, por lo que no recomendamos el IPL para ese tono de piel.',
    ...
    imageAlt:
      'Tabla de idoneidad del IPL: los tonos de piel Fitzpatrick I a V son adecuados y el tipo VI no lo es; el vello rubio oscuro, castaño y negro es adecuado, mientras que el rubio claro, pelirrojo y gris claro no lo son.',
  },
  fa: {
    heading: 'مناسب بودن برای پوست و مو',
    intro: 'دو چیز تعیین می‌کند که آیا IPL برای شما مناسب است: رنگ پوست و رنگ طبیعی موی شما.',
    skinTitle: 'رنگ پوست: Fitzpatrick I–V',
    skinBody:
      'برای رنگ‌های پوست از بسیار روشن تا قهوه‌ای مناسب است — انواع Fitzpatrick از I تا V. برای نوع VI (پوست با پیگمانتاسیون شدید) مناسب نیست: نور نمی‌تواند با دوز ایمن و مؤثر اعمال شود، بنابراین IPL را برای این رنگ پوست توصیه نمی‌کنیم.',
    ...
    imageAlt:
      'نمودار مناسب بودن IPL: رنگ‌های پوست Fitzpatrick از I تا V مناسب هستند و نوع VI مناسب نیست؛ موی بلوند تیره، قهوه‌ای و مشکی مناسب است، در حالی که موی بلوند روشن، قرمز و خاکستری روشن مناسب نیست.',
  },
  fr: {
    ...
    skinTitle: "Ton de peau : Fitzpatrick I–V",
    skinBody:
      "Convient aux tons de peau allant de très clair à brun — types Fitzpatrick I à V. Ne convient pas au type Fitzpatrick VI (peau fortement pigmentée) : la lumière ne peut pas être délivrée à une dose sûre et efficace, c’est pourquoi nous ne recommandons pas l’IPL pour ce ton de peau.",
    ...
    imageAlt:
      "Tableau de compatibilité IPL : les tons de peau Fitzpatrick I à V conviennent et le type VI non ; les poils blond foncé, bruns et noirs conviennent, tandis que les poils blond clair, roux et gris clair ne conviennent pas.",
  },
  he: {
    heading: 'התאמה לעור ולשיער',
    intro: 'שני דברים קובעים אם IPL מתאים לך: גוון העור שלך וצבע השיער הטבעי שלך.',
    skinTitle: 'גוון עור: Fitzpatrick I–V',
    skinBody:
      'מתאים לגווני עור מבהיר מאוד ועד חום — סוגי Fitzpatrick I עד V. לא מתאים לסוג Fitzpatrick VI (עור בעל פיגמנטציה עמוקה): לא ניתן להעביר את האור במינון בטוח ואפקטיבי, ולכן איננו ממליצים על IPL לגוון עור זה.',
    ...
    imageAlt:
      'טבלת התאמה ל-IPL: גווני עור Fitzpatrick I עד V מתאימים וסוג VI אינו מתאים; שיער בלונד כהה, חום ושחור מתאים, ואילו בלונד בהיר, אדום ואפור בהיר אינם מתאימים.',
  },
  id: {
    ...
    skinTitle: 'Warna kulit: Fitzpatrick I–V',
    skinBody:
      'Cocok untuk warna kulit dari sangat terang hingga cokelat — tipe Fitzpatrick I sampai V. Tidak cocok untuk tipe Fitzpatrick VI (kulit sangat berpigmen): cahaya tidak dapat diberikan dalam dosis yang aman dan efektif, sehingga kami tidak menyarankan IPL untuk warna kulit tersebut.',
    ...
    imageAlt:
      'Bagan kesesuaian IPL: warna kulit Fitzpatrick I sampai V cocok dan tipe VI tidak; rambut pirang gelap, cokelat, dan hitam cocok, sedangkan pirang terang, merah, dan abu-abu terang tidak cocok.',
  },
  it: {
    ...
    skinTitle: "Tono della pelle: Fitzpatrick I–V",
    skinBody:
      "Adatto ai toni di pelle dal molto chiaro al marrone — tipi Fitzpatrick da I a V. Non adatto al tipo Fitzpatrick VI (pelle molto pigmentata): la luce non può essere erogata a una dose sicura ed efficace, per questo non consigliamo l’IPL per quel tono di pelle.",
    ...
    imageAlt:
      "Tabella di idoneità IPL: i toni di pelle Fitzpatrick da I a V sono adatti e il tipo VI no; i peli biondo scuro, castani e neri sono adatti, mentre i biondo chiaro, rossi e grigio chiaro non lo sono.",
  },
  ja: {
    heading: '肌と毛の適合性',
    intro: 'IPL があなたに適しているかどうかは、2 つの要素で決まります。肌のトーンと、自然な毛の色です。',
    skinTitle: '肌のトーン：Fitzpatrick I–V',
    skinBody:
      'とても明るい肌から褐色の肌まで、Fitzpatrick タイプ I から V まで対応しています。Fitzpatrick タイプ VI（色素が非常に濃い肌）には適していません。安全で効果的な出力で光を照射できないため、この肌のトーンには IPL をおすすめしません。',
    ...
    imageAlt:
      'IPL 適合表：Fitzpatrick の肌トーン I から V は適合、タイプ VI は非適合です。濃いブロンド、茶色、黒の毛は適合し、明るいブロンド、赤、明るいグレーの毛は適合しません。',
  },
  ko: {
    heading: '피부와 털 적합성',
    intro: 'IPL이 나에게 맞는지는 두 가지로 결정됩니다. 피부 톤과 자연스러운 털 색입니다.',
    skinTitle: '피부 톤: Fitzpatrick I–V',
    skinBody:
      '아주 밝은 피부부터 갈색 피부까지 적합합니다 — Fitzpatrick I형에서 V형까지. Fitzpatrick VI형(색소가 매우 진한 피부)에는 적합하지 않습니다. 안전하고 효과적인 용량으로 빛을 조사할 수 없으므로 이 피부 톤에는 IPL을 권장하지 않습니다.',
    ...
    imageAlt:
      'IPL 적합성 표: Fitzpatrick 피부 톤 I에서 V는 적합하고 VI형은 적합하지 않습니다. 어두운 금발, 갈색, 검은색 털은 적합하며, 밝은 금발, 붉은색, 밝은 회색 털은 적합하지 않습니다.',
  },
  nl: {
    ...
    skinTitle: 'Huidtint: Fitzpatrick I–V',
    skinBody:
      'Geschikt voor huidtinten van zeer licht tot bruin — Fitzpatrick-type I tot en met V. Niet geschikt voor Fitzpatrick-type VI (sterk gepigmenteerde huid): het licht kan niet in een veilige, effectieve dosis worden afgegeven, daarom raden wij IPL voor die huidtint niet aan.',
    ...
    imageAlt:
      'IPL-geschiktheidstabel: Fitzpatrick-huidtinten I tot en met V zijn geschikt en type VI niet; donkerblond, bruin en zwart haar is geschikt, terwijl lichtblond, rood en lichtgrijs haar dat niet is.',
  },
  pl: {
    ...
    skinTitle: 'Odcień skóry: Fitzpatrick I–V',
    skinBody:
      'Odpowiedni dla odcieni skóry od bardzo jasnej do brązowej — typy Fitzpatrick od I do V. Nieodpowiedni dla typu Fitzpatrick VI (skóra silnie pigmentowana): światła nie można dostarczyć w bezpiecznej i skutecznej dawce, dlatego nie zalecamy IPL dla tego odcienia skóry.',
    ...
    imageAlt:
      'Tabela odpowiedniości IPL: odcienie skóry Fitzpatrick od I do V są odpowiednie, a typ VI nie; ciemnoblond, brązowe i czarne włosy są odpowiednie, natomiast jasnoblond, rude i jasnoszare nie są.',
  },
  'pt-BR': {
    ...
    skinTitle: 'Tom de pele: Fitzpatrick I–V',
    skinBody:
      'Adequado para tons de pele do muito claro ao moreno — tipos Fitzpatrick I a V. Não é adequado para o tipo Fitzpatrick VI (pele muito pigmentada): a luz não pode ser aplicada em uma dose segura e eficaz, por isso não recomendamos o IPL para esse tom de pele.',
    ...
    imageAlt:
      'Tabela de adequação do IPL: os tons de pele Fitzpatrick I a V são adequados e o tipo VI não; pelos loiro escuro, castanhos e pretos são adequados, enquanto loiro claro, ruivos e cinza claro não são.',
  },
  'pt-PT': {
    heading: 'Adequação para pele e pelos',
    ...
    skinTitle: 'Tom de pele: Fitzpatrick I–V',
    skinBody:
      'Adequado para tons de pele do muito claro ao moreno — tipos Fitzpatrick I a V. Não é adequado para o tipo Fitzpatrick VI (pele muito pigmentada): a luz não pode ser aplicada numa dose segura e eficaz, por isso não recomendamos o IPL para esse tom de pele.',
    ...
    imageAlt:
      'Tabela de adequação do IPL: os tons de pele Fitzpatrick I a V são adequados e o tipo VI não; pelos loiro escuro, castanhos e pretos são adequados, enquanto loiro claro, ruivos e cinzento claro não são.',
  },
  ro: {
    ...
    skinTitle: 'Tonul pielii: Fitzpatrick I–V',
    skinBody:
      'Potrivit pentru tonuri de piele de la foarte deschis la brun — tipurile Fitzpatrick I până la V. Nu este potrivit pentru tipul Fitzpatrick VI (piele puternic pigmentată): lumina nu poate fi aplicată într-o doză sigură și eficientă, așa că nu recomandăm IPL pentru acest ton de piele.',
    ...
    imageAlt:
      'Tabel de potrivire IPL: tonurile de piele Fitzpatrick I până la V sunt potrivite, iar tipul VI nu; părul blond închis, brun și negru este potrivit, în timp ce părul blond deschis, roșcat și gri deschis nu este.',
  },
  ru: {
    ...
    skinTitle: 'Тон кожи: Fitzpatrick I–V',
    skinBody:
      'Подходит для тонов кожи от очень светлого до коричневого — типы Fitzpatrick с I по V. Не подходит для типа Fitzpatrick VI (сильно пигментированная кожа): свет невозможно подать в безопасной и эффективной дозе, поэтому мы не рекомендуем IPL для такого тона кожи.',
    ...
    imageAlt:
      'Таблица пригодности IPL: тоны кожи Fitzpatrick с I по V подходят, тип VI — нет; волосы тёмного блонда, коричневые и чёрные подходят, а светлого блонда, рыжие и светло-серые — нет.',
  },
  th: {
    heading: 'ความเหมาะสมสำหรับผิวและขน',
    intro: 'มีสองสิ่งตัดสินว่า IPL เหมาะกับคุณหรือไม่ คือสีผิวและสีขนตามธรรมชาติของคุณ',
    skinTitle: 'สีผิว: Fitzpatrick I–V',
    skinBody:
      'เหมาะกับสีผิวตั้งแต่สีอ่อนมากจนถึงสีน้ำตาล — Fitzpatrick ประเภท I ถึง V ไม่เหมาะกับ Fitzpatrick ประเภท VI (ผิวที่มีเม็ดสีเข้มมาก) เนื่องจากไม่สามารถยิงแสงในปริมาณที่ปลอดภัยและได้ผล จึงไม่แนะนำให้ใช้ IPL กับสีผิวประเภทนี้',
    ...
    imageAlt:
      'ตารางความเหมาะสมของ IPL: สีผิว Fitzpatrick I ถึง V เหมาะสม ส่วนประเภท VI ไม่เหมาะสม ขนสีบลอนด์เข้ม สีน้ำตาล และสีดำเหมาะสม ขณะที่ขนสีบลอนด์อ่อน สีแดง และสีเทาอ่อนไม่เหมาะสม',
  },
  tr: {
    heading: 'Cilt ve tüy uygunluğu',
    intro: "IPL'in size uygun olup olmadığını iki şey belirler: cilt tonunuz ve doğal tüy renginiz.",
    skinTitle: 'Cilt tonu: Fitzpatrick I–V',
    skinBody:
      'Çok açık ten ile kahverengi arasındaki cilt tonları için uygundur — Fitzpatrick tip I ile V arası. Fitzpatrick tip VI (yoğun pigmentli cilt) için uygun değildir: ışık güvenli ve etkili bir dozda verilemediği için bu cilt tonu için IPL önermiyoruz.',
    ...
    imageAlt:
      'IPL uygunluk tablosu: Fitzpatrick cilt tonları I ile V uygundur, tip VI uygun değildir; koyu sarı, kahverengi ve siyah tüyler uygundur, açık sarı, kızıl ve açık gri tüyler ise uygun değildir.',
  },
  vi: {
    ...
    skinTitle: 'Tông màu da: Fitzpatrick I–V',
    skinBody:
      'Phù hợp với các tông da từ rất sáng đến nâu — các tuýp Fitzpatrick từ I đến V. Không phù hợp với tuýp Fitzpatrick VI (da có sắc tố đậm): ánh sáng không thể được chiếu ở liều an toàn và hiệu quả, vì vậy chúng tôi không khuyến nghị dùng IPL cho tông da này.',
    ...
    imageAlt:
      'Bảng mức độ phù hợp của IPL: các tông da Fitzpatrick từ I đến V phù hợp và tuýp VI không phù hợp; lông vàng đậm, nâu và đen phù hợp, trong khi lông vàng nhạt, đỏ và xám nhạt không phù hợp.',
  },
};
