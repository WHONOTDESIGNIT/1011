...
export const LANGUAGE_CONFIG: LanguageMeta[] = [
  ...
  { code: "ro",    countryCode: "ro", label: "Romanian",    nativeName: "Română",                 flagUrl: flag("ro"), enabled: false },
  ...
  { code: "pl",    countryCode: "pl", label: "Polish",      nativeName: "Polski",                 flagUrl: flag("pl"), enabled: false },
];
