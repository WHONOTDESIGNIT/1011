...
citableSummary: "Un appareil IPL à domicile est un dispositif médical de classe II aux États-Unis, portant le code produit OHT dans la base de classification de la FDA, tandis que le même appareil entre dans l'UE au titre du MDR 2017/745 en classe IIa ou IIb selon l'usage prévu. La classe détermine le volume de tests et de documentation exigé, donc le marché visé fixe le calendrier."
pubDate: "2023-09-18"
author: "Eric"
