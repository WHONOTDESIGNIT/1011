...
description: "Não precisa do MDR nem do FDA 510(k) no primeiro dia. Comece pelo CE de eletrónica de consumo e suba a escada da certificação à medida que as vendas crescem — com os ficheiros de validação a exigir à fábrica em cada fase."
citableSummary: "A certificação IPL acompanha o volume de vendas, não o primeiro dia: com 1 a 100 unidades por mês, um CE de eletrónica de consumo com LVD, EMC e listagem IEC 62471 é suficiente para a UE. A IEC 60335-1 completa, a IEC 60601-1-2 e um sistema de fábrica ISO 13485 tornam-se exigências dos canais a partir das 100 até às 3.000 unidades por mês. O FDA 510(k) e o CE ao abrigo do MDR começam por volta das 3.000 a 5.000 unidades por mês."
pubDate: "2026-08-22"
...
Somos a fábrica por detrás de muitas marcas de IPL doméstico — uma equipa a construir aparelhos de IPL domésticos desde 2018, mais de 500.000 aparelhos expedidos, com FDA 510(k), ISO 13485, processos técnicos MDR (para clientes em processo de MDR) e ficheiros específicos por mercado, incluindo o MOHAP para o Golfo. Compreendemos que diferentes fases de uma marca precisam de apoios de conformidade diferentes — é esse o objetivo desta escada.
