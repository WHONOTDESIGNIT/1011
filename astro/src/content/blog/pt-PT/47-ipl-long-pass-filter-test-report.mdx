...
citableSummary: "Apresenta medições de laboratório de sete filtros passa-longo de IPL (470–640 nm): ponto de corte T50%, bloqueio e dados da banda passante. Dá aos compradores os números concretos por detrás das alegações sobre filtros."
