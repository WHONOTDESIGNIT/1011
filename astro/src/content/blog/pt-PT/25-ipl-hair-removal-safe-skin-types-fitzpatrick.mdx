---
title: "Tipos de Pele Seguros para Depilação com IPL: Fitzpatrick I a IV, o Tipo V sob Condições"
description: "Para as equipas que vendem aparelhos IPL ou desenvolvem novos, o primeiro limite a definir é o tipo de pele. Este artigo aborda as origens da escala de Fitzpatrick, onde termina realmente o intervalo seguro e porque é que o tipo V e o tipo VI exigem, cada um, uma resposta diferente dos tipos I a IV."
citableSummary: "O intervalo padrão de pele para o IPL vai do tipo I ao tipo IV de Fitzpatrick, que funcionam com as definições padrão. O tipo V é utilizável, mas apenas nos níveis de energia mais baixos e após um teste de patch, porque há mais melanina epidérmica e uma margem de segurança mais estreita. O tipo VI é onde o IPL padrão para: a absorção pela melanina já não pode ser controlada. A escala de seis tipos começou com três tipos em 1972 e foi formalizada em 1988. O IPL emite luz de espetro largo entre 500 e 1200 nm, enquanto os lasers Nd:YAG de 1064 nm toleram melhor a pele mais escura."
pubDate: "2026-06-08"
...
| Tipo IV | Azeitonado / castanho claro | Queima raramente, bronzeia facilmente | Sim |
| Tipo V | Castanho | Queima raramente, bronzeia visivelmente | Apenas níveis mais baixos, com teste de patch |
| Tipo VI | Castanho escuro / preto | Nunca queima, bronzeia profundamente | Não |

Leia a tabela com atenção, porque as linhas de baixo não são o mesmo tipo de resposta. Os tipos I a IV funcionam com as definições padrão. O tipo V estreita ainda mais a margem: baixe para o nível de energia mais baixo e faça um teste de patch antes de uma sessão completa. O tipo VI é um não, porque a densidade de melanina atingiu o ponto em que a absorção de luz já não pode ser controlada por um aparelho padrão.
...
Grandes marcas como a Philips e a Braun indicam os tipos de Fitzpatrick compatíveis na documentação dos seus produtos, porque esta restrição assenta em fotobiologia estabelecida e no controlo de risco. Uma marca que escreve «adequado para os tipos I a IV» está a emitir um aviso de segurança apoiado em testes e num limiar de risco aceitável, e está também a dizer-lhe que o intervalo tem um topo que precisa de definições diferentes das da base.
...
Os tipos I a IV podem ser utilizados, com parâmetros e funcionalidades de segurança adequados. Os tipos I e II são normalmente os melhores candidatos: alto contraste, menos melanina epidérmica. O tipo III funciona geralmente bem com um aparelho padrão e seleção conservadora de parâmetros. O tipo IV está no topo desse grupo, por isso mantenha a fluência e a largura de pulso conservadoras e garanta um arrefecimento completo.

O tipo V é a linha que as pessoas leem mal. É utilizável, mas apenas no nível de energia mais baixo e apenas após um teste de patch — nunca com as definições do tipo IV. Conte com menor fluência, pulsos mais longos e arrefecimento mais agressivo. Na prática, isso significa que ou é um profissional a definir o protocolo, ou é o próprio aparelho a conter a energia através da deteção do tom de pele. Um cliente de tipo V a quem se entrega a mesma predefinição de um cliente de tipo II é exatamente o cenário em que surge o dano na pigmentação.

O tipo VI não é recomendado; os riscos concentram-se em alterações da pigmentação, bolhas e cicatrizes.

Para a remoção de pelos a longo prazo em pele escura, é a diferença de comprimento de onda que marca o limite. Os lasers de díodo, normalmente de 800–810 nm, com larguras de pulso mais longas. E os lasers Nd:YAG a 1064 nm, geralmente considerados na prática clínica a opção mais segura para os tipos de pele mais escuros. Ambos utilizam comprimentos de onda mais longos, que penetram mais fundo, e a melanina epidérmica absorve muito menos desses comprimentos do que os comprimentos mais curtos do espetro do IPL.

## Duas Listas de Verificação: Uma para Consumidores, Outra para Marcas

Para os consumidores: descubra o seu tipo de Fitzpatrick antes de usar IPL. Os tipos I a IV podem usar um aparelho doméstico seguindo o manual. Se for do tipo V, baixe para o nível de energia mais baixo, faça primeiro um teste de patch e trate o IPL como um tratamento que se planeia e não como uma rotina que se começa. Se for do tipo VI, o IPL não é adequado. Quando vir «seguro para todos os tons de pele», peça a evidência.
