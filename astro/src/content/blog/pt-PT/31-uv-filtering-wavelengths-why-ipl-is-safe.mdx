...
citableSummary: "Os aparelhos de IPL não são solários: os aparelhos de bronzeamento com UV foram classificados como carcinogénicos do Grupo 1 pela Agência Internacional de Investigação do Cancro em 2009, enquanto o IPL utiliza uma saída ótica filtrada e controlada. A questão de segurança é saber que comprimentos de onda um aparelho emite, quais filtra e se a potência de saída é controlada. Não ter UV não significa automaticamente que seja seguro."
pubDate: "2026-07-07"
author: "iShine Team"
category: "Safety"
