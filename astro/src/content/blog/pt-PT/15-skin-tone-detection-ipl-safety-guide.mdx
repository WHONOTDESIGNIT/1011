...
citableSummary: "A deteção do tom de pele lê a pele com luz vermelha de 640 ou 660 nanómetros mais infravermelho de 800 ou 870 nanómetros, comparando a proporção com uma tabela de segurança armazenada. O Fitzpatrick VI não dispara, o tipo V desce ao nível de energia mais baixo, os tipos III e IV reduzem a energia em 20 a 40 por cento, e os tipos I e II funcionam com energia total. Os aparelhos certificados usam deteção de duplo comprimento de onda."
pubDate: "2026-05-21"
author: "Eric"
...
Passo três, julgar. O aparelho compara o valor medido contra uma tabela de segurança pré-armazenada. Fitzpatrick VI: sem flash, alerta. V: energia reduzida ao nível mais baixo, teste de uma pequena área recomendado. III ou IV: energia reduzida 20-40% versus tipo II. I ou II: energia total.
...
No topo está a escala de Fitzpatrick, a camada que os utilizadores veem. Os aparelhos usam-na para mostrar o tipo de pele e para definir a energia internamente. Os aparelhos IPL domésticos seguros suportam geralmente os tipos I a IV com as definições padrão, com o tipo V limitado ao nível de energia mais baixo e a um teste de patch; o tipo VI deve estar totalmente bloqueado.
...
Um relato de queimadura no TikTok ou nas avaliações da Amazon pode acabar com uma marca. O inverso também é verdade: um aparelho que funciona em segurança de Fitzpatrick I a IV detém uma vantagem competitiva que as marcas ainda calibradas para pele branca não têm.
