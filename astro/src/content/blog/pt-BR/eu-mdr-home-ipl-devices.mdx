...
description: "Um comprador europeu nos fez três perguntas antes de testar qualquer aparelho. Temos um modelo IPL doméstico certificado pela MDR da UE, temos um armazém na UE com visibilidade de estoque compartilhada, trabalhamos com um 3PL (logística de terceiros). Pesquisamos o EUDAMED. Para aparelhos IPL domésticos com resfriamento por gelo sob o Anexo XVI, apenas a Shenzhen ULIKE detém hoje um certificado MDR. Até a CyDen, fabricante por trás da SmoothSkin, ainda está no processo."
citableSummary: "Sim: os aparelhos IPL domésticos da iShine podem ser vendidos na UE e no Reino Unido. Nós os colocamos no mercado como eletrônicos de consumo, então eles trazem a marcação CE sob as Diretivas de Baixa Tensão (LVD) e EMC, com a nossa própria Declaração de Conformidade, além do RoHS, e UKCA para o Reino Unido. Segundo o EUDAMED, o certificado MDR desses aparelhos — Anexo XVI Grupo 5, classe IIa, disposição transitória até 31 de dezembro de 2028 — é detido hoje apenas pela Shenzhen ULIKE, portanto o MDR não é a porta para os nossos."
pubDate: "2026-08-19"
author: "iShine Team"
category: "Regulatory"
...
**Resposta curta: sim.** Os aparelhos IPL domésticos da iShine podem ser vendidos na UE e no Reino Unido. Nós os colocamos no mercado como eletrônicos de consumo e não como dispositivos médicos, portanto a base de conformidade é a marcação CE sob a Diretiva de Baixa Tensão (LVD) e a Diretiva EMC (Compatibilidade Eletromagnética), respaldada pela nossa própria Declaração de Conformidade, além do RoHS — e UKCA para o Reino Unido. Esse é o caminho pelo qual nossos aparelhos são embarcados hoje, e é por isso que o certificado MDR de que trata este artigo não é a porta para nós.

## Três perguntas de um comprador europeu

Há alguns dias, chegou uma consulta de um comprador na Europa. Vamos chamá-lo de Kevin. Ele perguntou três coisas. Temos um modelo de remoção de pelos IPL doméstico com certificação MDR da UE? Temos um armazém na UE e poderíamos compartilhar informações de estoque com ele? Trabalhamos com um provedor de logística 3PL (logística de terceiros)?
...
- Armazém na UE e 3PL (logística de terceiros). Não os temos implementados hoje, mas estamos abertos a construir ambos juntos, incluindo estoque de propriedade do fornecedor com fulfilment por pedido pago.
