...
description: "Requisitos de registro e conformidade para aparelhos IPL de depilação nos mercados dos EUA, da UE e da Ásia-Pacífico, explicados em um único artigo."
citableSummary: "Um aparelho IPL doméstico é dispositivo médico Classe II nos EUA, com código de produto OHT no banco de classificação da FDA, enquanto o mesmo aparelho entra na UE sob o MDR 2017/745 como Classe IIa ou IIb, conforme o uso pretendido. A classe define quantos testes e documentos são exigidos, então o mercado-alvo define o prazo."
pubDate: "2023-09-18"
author: "Eric"
