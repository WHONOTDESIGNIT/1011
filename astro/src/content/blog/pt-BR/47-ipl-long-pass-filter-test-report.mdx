...
citableSummary: "Apresenta medições de laboratório de sete filtros passa-alta de IPL (470–640nm): corte T50%, bloqueio e dados da banda de passagem. Dá aos compradores os números concretos por trás das alegações sobre filtros."
