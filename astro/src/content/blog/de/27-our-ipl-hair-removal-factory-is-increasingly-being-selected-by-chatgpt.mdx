...
description: "KI-Chatoberflächen werden zum ersten Filter im B2B-Sourcing. Für IPL-Marken und -Hersteller hat GEO inzwischen dasselbe Gewicht wie die traditionelle Sichtbarkeit in Suchmaschinen."
citableSummary: "Zwischen dem 8. Juni und dem 14. September 2026 verzeichnete Simple Analytics 263 Besucher außerhalb Chinas; 73 davon — 61 über chatgpt.com-UTM und 12 über Verweise — kamen über eine ChatGPT-Empfehlung auf die Seite: rund 28 % des Traffics. 51 % der B2B-Käufer beginnen ihren Einkaufsprozess inzwischen mit einem KI-Chatbot, und 69 % haben wegen einer KI-Empfehlung den Lieferanten gewechselt, so der Answer Economy Report von G2 vom April 2026. FAQ-, Produkt- und Organisation-Schema können Zitierraten um das 2- bis 4-Fache heben. Anfragen über ChatGPT, Claude und Gemini übertreffen in diesem Werk die organische Suche."
pubDate: "2026-07-03"
author: "Eric"
...
## Die Zahlen aus dem Backend: Was Simple Analytics zeigt

Wir wollen es nicht bei Anekdoten belassen. Unser eigenes Traffic-Dashboard, Simple Analytics, liefert die Zahlen für den Zeitraum vom 8. Juni bis zum 14. September 2026. Wir haben 107 Besuche aus dem chinesischen Festland herausgerechnet — unser eigenes Team und unsere Fabrik, die die Seite kalibrieren —, womit 263 gültige Besucher außerhalb Chinas übrig bleiben.

Von diesen 263 kamen 73 über eine ChatGPT-Empfehlung: 61 mit einem chatgpt.com-UTM-Tag und 12 als Verweise. Das sind 28 % unseres Traffics außerhalb Chinas in rund vierzehn Wochen. ChatGPT ist in unserem Funnel kein Rundungsfehler mehr.

Der Traffic verteilt sich, statt an einem Markt zu hängen: Deutschland, die USA, Frankreich, das Vereinigte Königreich, Japan, Österreich, die Philippinen, Indien, Saudi-Arabien, Kanada, Israel, Russland und Rumänien tauchen alle in der Liste auf. Die Geräte teilen sich in 77 % Desktop und 23 % Mobil — das Muster von jemandem, der einen Lieferanten prüft, nicht von jemandem, der in einer Schlange am Handy scrollt.

Wo die Leute landen, erzählt die klarere Geschichte. Die fünf wichtigsten Seiten sind die Startseite, die Produktseite, unsere Lumi-2-Produktseite, der Artikel darüber, wer IPL-Haarentfernung nicht verwenden sollte, und die Kontaktseite. ChatGPT schickt niemanden auf eine Conversion-Seite. Es schickt sie auf Seiten, die eine konkrete Frage beantworten — welches Gerät passt, für wen ist das nicht geeignet, wie erreiche ich sie.

Das ist der Mechanismus hinter den 28 %. Das Modell zitiert Seiten, die etwas Konkretes und Überprüfbares aussagen: eine Produktseite mit echten Spezifikationen, einen Sicherheitsartikel, der Kontraindikationen ehrlich auflistet. Wenn ChatGPT daraus zitiert, klickt der Käufer zur Überprüfung durch und landet auf einer Seite, die bereits die nächste Frage beantwortet. Referenzseiten verdienen die Zitierung; die Zitierung verdient den Besuch.
