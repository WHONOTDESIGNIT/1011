---
title: "Bezpieczne typy skóry do depilacji IPL: Fitzpatrick od I do V, nie VI"
description: "Dla zespołów sprzedających urządzenia IPL lub opracowujących nowe pierwszym limitem, który trzeba wyznaczyć, jest typ skóry. W tym artykule omawiamy pochodzenie skali Fitzpatricka, to, gdzie naprawdę kończy się bezpieczny zakres, oraz to, dlaczego typ V i typ VI wymagają różnych odpowiedzi."
citableSummary: "Zakres, w którym można stosować IPL, obejmuje typy Fitzpatricka od I do V. Typy I–IV działają na standardowych ustawieniach. Typ V jest możliwy, ale wymaga obniżonej gęstości energii, dłuższych czasów impulsu, dokładnego chłodzenia i prowadzenia przez specjalistę, bo większa zawartość melaniny w naskórku pozostawia węższy margines bezpieczeństwa. Na typie VI standardowe IPL się zatrzymuje: absorpcji melaniny nie da się już kontrolować. Sześciostopniowa skala zaczynała się od trzech typów w 1972 roku i została sformalizowana w 1988 roku. IPL emituje szerokopasmowe światło od 500 do 1200 nm, a lasery Nd:YAG 1064 nm lepiej tolerują ciemniejszą skórę."
pubDate: "2026-06-08"
...
Pierwsza decyzja o tym, komu można sprzedać urządzenie IPL do usuwania włosów, dotyczy typu skóry wg skali Fitzpatricka. Uruchomienie standardowych ustawień u klienta z typem VI kończy się poparzeniami, hiperpigmentacją, a w ciężkich przypadkach nieodwracalnym uszkodzeniem skóry. Typ V leży tuż przy tej granicy i potrzebuje własnych parametrów, a nie kopii ustawień przewidzianych dla typu II. Tę granicę wyznacza fotobiologia — jedynym zadaniem producenta jest jasne oznaczenie wniosku.

## Gdzie naprawdę kończy się bezpieczny zakres

Skala Fitzpatricka dzieli skórę na sześć typów według reakcji na oparzenia słoneczne i opalanie. Zakres, w którym można stosować IPL, obejmuje typy od I do V. Typy I–IV to rutynowe zabiegi na standardowym urządzeniu. Typ V jest wykonalny, ale wyłącznie przy niższej energii i z protokołem ustawionym przez osobę, która zna ten typ skóry. Do wykluczenia pozostaje typ VI, ponieważ ryzyko uszkodzenia termicznego jest zbyt wysokie niezależnie od dobranych parametrów.
...
| Typ V | Brązowy | Rzadko się oparza, wyraźnie się opala | Tak, niższa gęstość energii i prowadzenie przez specjalistę |
| Typ VI | Ciemnobrązowy / czarny | Nigdy się nie oparza, opala się najmocniej | Nie |

Proszę przeczytać tabelę w całości, bo jej ostatnie trzy wiersze to nie ten sam rodzaj odpowiedzi. Komórka typu IV mówi: można używać, ale ostrożnie — fluencja i czas trwania impulsu konserwatywnie, chłodzenie dokładne. Typ V zwęża margines jeszcze bardziej i wymaga, by parametry ustawił specjalista. Typ VI to „nie", bo gęstość melaniny osiąga poziom, przy którym standardowe urządzenie nie kontroluje już absorpcji światła.
...
Mainstreamowe marki, takie jak Philips i Braun, podają kompatybilne typy Fitzpatricka w dokumentacji produktu, ponieważ to ograniczenie opiera się na ugruntowanej fotobiologii i kontroli ryzyka. Marka pisząca „odpowiedni dla typów od I do V" wydaje ostrzeżenie bezpieczeństwa poparte testami i akceptowalnym progiem ryzyka, a jednocześnie mówi, że górna część tego zakresu wymaga innych ustawień niż dolna.
...
Typ V to wiersz, który najczęściej bywa czytany błędnie. Można go stosować, tylko nie na ustawieniach przewidzianych dla typu IV. Należy się spodziewać niższej gęstości energii, dłuższych czasów impulsu, bardziej intensywnego chłodzenia oraz testu płatkowego przed pełną sesją. W praktyce oznacza to albo protokół ustawiony przez specjalistę, albo utrzymywanie energii na niskim poziomie przez czujnik odcienia skóry w samym urządzeniu. Klient z typem V, który dostaje ten sam preset co klient z typem II, to dokładnie ten scenariusz, w którym dochodzi do uszkodzenia pigmentacji.

Typ VI nie jest zalecany; ryzyko koncentruje się w zmianach pigmentacyjnych, pęcherzach i bliznach. Dla tego typu skóry w warunkach profesjonalnych rozważa się zwykle inne technologie oparte na świetle.
...
Dla konsumentów: przed użyciem IPL ustalcie swój typ Fitzpatricka. Typy od I do IV mogą korzystać z urządzenia domowego zgodnie z instrukcją. Jeśli macie typ V, traktujcie IPL jako zabieg, który trzeba zaplanować, a nie rutynę, którą się zaczyna: niższa energia, dłuższe impulsy i najpierw opinia specjalisty. Jeśli macie typ VI, trzymajcie się z daleka od urządzeń IPL, chyba że wykwalifikowany lekarz wyda konkretne zalecenie dla konkretnego urządzenia i protokołu. Gdy widzicie napis „bezpieczny dla wszystkich odcieni skóry", poproście o dowody. Jeśli macie ciemną skórę i chcecie usunąć włosy, zapytajcie w profesjonalnej klinice o opcje laserowe.
