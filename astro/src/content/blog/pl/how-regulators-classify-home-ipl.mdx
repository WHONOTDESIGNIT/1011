...
Szczegół, który stale powraca u kanadyjskich klientów, to wykrywanie koloru skóry. Health Canada oczekuje, że urządzenie bezpiecznie poradzi sobie z ryzykiem ciemniejszej skóry, a czujnik koloru skóry jest właśnie tym mechanizmem. Opisaliśmy to w [artykule o czujniku koloru skóry](/blog/15-skin-tone-detection-ipl-safety-guide), ale w skrócie: Kanada traktuje czujnik jako konieczność bezpieczeństwa, a nie dodatek.
