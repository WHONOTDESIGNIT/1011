---
title: "Fototipi sicuri per la rimozione dei peli con IPL: da Fitzpatrick I a V, non VI"
description: "Per i team che vendono dispositivi IPL o ne sviluppano di nuovi, il primo confine da stabilire è il fototipo. Questo articolo copre le origini della scala di Fitzpatrick, dove finisce davvero l'intervallo sicuro e perché il Tipo V e il Tipo VI richiedono risposte diverse."
citableSummary: "L'intervallo di pelle utilizzabile per l'IPL va dal Fitzpatrick Tipo I al Tipo V. I tipi da I a IV funzionano con le impostazioni standard. Il Tipo V è utilizzabile ma richiede densità di energia ridotta, impulsi più lunghi, raffreddamento accurato e una guida professionale, perché una melanina epidermica più alta lascia un margine di sicurezza più sottile. Il Tipo VI è il punto in cui l'IPL standard si ferma: l'assorbimento della melanina non è più controllabile. La scala a sei tipi è nata con tre tipi nel 1972 ed è stata formalizzata nel 1988. L'IPL emette luce a spettro ampio da 500–1200 nm, mentre i laser Nd:YAG a 1064 nm tollerano meglio la pelle più scura."
pubDate: "2026-06-08"
...
La prima decisione su a chi può essere venduto un dispositivo IPL per la rimozione dei peli è il fototipo di Fitzpatrick. Applicate le impostazioni standard su un cliente con pelle di tipo VI e il risultato sono ustioni, iperpigmentazione e, nei casi gravi, danni cutanei irreversibili. Il tipo V sta vicino a quel confine e richiede parametri propri, non una copia del preset del tipo II. Quel confine è stabilito dalla fotobiologia; l'unico compito del produttore è marcare chiaramente la conclusione.

## Dove finisce davvero l'intervallo sicuro

La scala di Fitzpatrick classifica la pelle in sei tipi in base alla sua risposta alle scottature e all'abbronzatura. L'intervallo utilizzabile dell'IPL va dal tipo I al tipo V. I tipi da I a IV sono routine su un dispositivo standard. Il tipo V è praticabile, ma solo con energia più bassa e con qualcuno competente che imposta il protocollo. Il tipo VI è quello da escludere, perché il rischio di lesioni termiche resta troppo alto qualunque sia la regolazione dei parametri.
...
| Tipo V | Marrone | Si scotta raramente, si abbronza sensibilmente | Sì, con densità di energia ridotta e guida professionale |
| Tipo VI | Marrone scuro / nero | Non si scotta mai, si abbronza al massimo | No |

Leggete la tabella per intero, perché le ultime tre righe non sono lo stesso tipo di risposta. La cella del Tipo IV dice utilizzabile ma con cautela: mantenete fluenza e durata dell'impulso su valori prudenti e rendete il raffreddamento accurato. Il Tipo V restringe ulteriormente il margine e prevede che sia un professionista a impostare i parametri. Il Tipo VI è un no, perché la densità di melanina ha raggiunto il punto in cui l'assorbimento della luce non può più essere controllato da un dispositivo standard.
...
Il tipo V è la riga che si legge male. È utilizzabile, semplicemente non con le impostazioni del tipo IV. Aspettatevi densità di energia più bassa, impulsi più lunghi, raffreddamento più aggressivo e un test su una piccola area prima di una seduta completa. In pratica significa che o è un professionista a impostare il protocollo, oppure è il dispositivo stesso a tenere bassa l'energia tramite il rilevamento del tono della pelle. Un cliente di tipo V a cui viene dato lo stesso preset di un cliente di tipo II è esattamente lo scenario in cui si verificano i danni al pigmento.

Il tipo VI non è raccomandato; i rischi si concentrano in alterazioni del pigmento, vesciche e cicatrici. Per questo fototipo, in ambito professionale si prendono generalmente in considerazione altre tecnologie basate sulla luce.
