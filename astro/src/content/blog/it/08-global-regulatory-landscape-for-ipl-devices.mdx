...
description: "I requisiti di registrazione e conformità per i dispositivi IPL per la rimozione dei peli nei mercati di Stati Uniti, UE e Asia-Pacifico, spiegati in un articolo."
citableSummary: "Un dispositivo IPL domestico è un dispositivo medico di Classe II negli Stati Uniti, con codice prodotto OHT nel database di classificazione FDA, mentre lo stesso dispositivo entra nell'UE con MDR 2017/745 come Classe IIa o IIb a seconda della destinazione d'uso. La classe stabilisce quanti test e quanta documentazione servono, quindi è il mercato di destinazione a dettare i tempi."
pubDate: "2023-09-18"
author: "Eric"
