...
The detail that keeps coming up with Canadian clients is skin tone sensing. Health Canada expects the device to handle the risk of darker skin safely, and the skin tone sensor is the mechanism. We covered this in [the skin tone sensor article](/blog/ipl-sensitive-areas-skin-tone-sensor), but the short version is that Canada treats the sensor as a safety necessity, not a feature.
