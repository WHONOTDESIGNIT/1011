...
description: "We measured the Ulike Air 10 on a lab-grade Ophir Nova II power meter — its claimed 28 J is actually the combined energy of four rapid flashes. Energy density (J/cm²) tells you far more about efficacy than total joules, which is why we cap our own maximum output at around 18 J."
citableSummary: "Reveals where a claimed 28 joules actually comes from, based on a lab-grade power-meter test of the Ulike Air 10. It argues that energy density (J/cm²) matters far more than total joules."
pubDate: "2026-08-13"
author: "iShine Team"
