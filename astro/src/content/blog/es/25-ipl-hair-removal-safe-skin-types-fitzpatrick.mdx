---
title: "Fototipos de piel seguros para la depilación IPL: Fitzpatrick I a V, no VI"
...
| Tipo V | Marrón | Rara vez se quema, se broncea notablemente | Sí, con menor fluencia y orientación profesional |
| Tipo VI | Marrón oscuro / negro | Nunca se quema, se broncea al máximo | No |

Lee la tabla completa, porque las tres últimas filas no son el mismo tipo de respuesta. La celda del tipo IV dice utilizable pero con precaución: mantén la fluencia y la duración de pulso conservadoras y haz que la refrigeración sea minuciosa. El tipo V estrecha aún más el margen y espera que un profesional fije los parámetros. El tipo VI es un no, porque la densidad de melanina ha llegado al punto en que la absorción de luz ya no se puede controlar con un dispositivo estándar.
...
El tipo V es la fila que la gente malinterpreta. Es utilizable, solo que no con los ajustes del tipo IV. Espera menor fluencia, pulsos más largos, refrigeración más agresiva y una prueba en una zona pequeña antes de una sesión completa. En la práctica, eso significa que o un profesional fija el protocolo o el propio dispositivo mantiene la energía baja mediante la detección del tono de piel. Un cliente de tipo V al que se le entrega el mismo preajuste que a un cliente de tipo II es exactamente el escenario en el que ocurre el daño de pigmentación.

El tipo VI no se recomienda; los riesgos se concentran en cambios de pigmentación, ampollas y cicatrices. Para este fototipo, en entornos profesionales se consideran generalmente otras tecnologías basadas en luz.
...
Para los consumidores: averigua tu tipo de Fitzpatrick antes de usar IPL. Los tipos I a IV pueden usar un dispositivo doméstico siguiendo el manual. Si eres tipo V, trata el IPL como un tratamiento que se planifica y no como una rutina que se empieza: menos energía, pulsos más largos y primero la opinión de un profesional. Si eres tipo VI, aléjate de los dispositivos IPL a menos que un médico cualificado dé una recomendación específica para un dispositivo y un protocolo concretos. Cuando veas «seguro para todos los tonos de piel», pide la evidencia. Si tienes piel oscura y quieres depilación, pregunta en una clínica profesional por las opciones de láser.
