...
description: "Evropský kupující se nás před testováním jakéhokoli přístroje zeptal na tři otázky. Máme domácí IPL model certifikovaný podle EU MDR, máme sklad v EU se sdílenou viditelností zásob, spolupracujeme s 3PL (logistika třetích stran). Prohledali jsme EUDAMED. U domácích IPL přístrojů s ledovým chlazením podle Annex XVI drží dnes certifikát MDR pouze Shenzhen ULIKE. Dokonce i CyDen, výrobce stojící za SmoothSkin, proces stále prochází."
citableSummary: "Ano: domácí IPL přístroje iShine lze prodávat v EU a ve Spojeném království. Uvádíme je na trh jako spotřební elektroniku, proto nesou označení CE podle směrnice o nízkém napětí a směrnice o elektromagnetické kompatibilitě spolu s naším vlastním prohlášením o shodě, dále RoHS a UKCA pro Spojené království. Podle EUDAMED drží certifikát MDR pro tyto přístroje — Annex XVI skupina 5, riziková třída IIa, přechodné ustanovení do 31. prosince 2028 — dnes pouze Shenzhen ULIKE, takže MDR není pro naše přístroje vstupní podmínkou."
pubDate: "2026-08-19"
author: "iShine Team"
category: "Regulatory"
...
**Krátká odpověď: ano.** Domácí IPL přístroje iShine lze prodávat v EU a ve Spojeném království. Uvádíme je na trh jako spotřební elektroniku, nikoli jako zdravotnické prostředky, proto je základem shody označení CE podle směrnice o nízkém napětí a směrnice o elektromagnetické kompatibilitě, podložené naším vlastním prohlášením o shodě, dále RoHS — a UKCA pro Spojené království. To je cesta, po níž se naše přístroje dnes dodávají, a proto certifikát MDR, o kterém tento článek je, pro nás není vstupní podmínkou.

## Tři otázky od evropského kupujícího

Před pár dny přišla poptávka od kupujícího v Evropě. Říkejme mu Kevin. Zeptal se na tři věci. Máme domácí IPL model na odstraňování chloupků s certifikací EU MDR? Máme sklad v EU a mohli bychom s ním sdílet informace o zásobách? Spolupracujeme s externím 3PL (logistika třetích stran) logistickým poskytovatelem?
...
- Sklad v EU a 3PL (logistika třetích stran). Dnes je nemáme, ale jsme otevřeni obojí vybudovat společně, včetně zásob ve vlastnictví dodavatele s fulfilmentem platbou za objednávku.
