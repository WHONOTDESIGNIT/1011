---
title: "Veilige huidtypen voor IPL-haarverwijdering: Fitzpatrick I–IV, type V onder voorwaarden"
description: "Voor teams die IPL-apparaten verkopen of nieuwe ontwikkelen, is het eerste uitgangspunt het huidtype. Dit artikel behandelt de oorsprong van de Fitzpatrick-schaal, waar het veilige bereik werkelijk eindigt en waarom type V en type VI elk een ander antwoord vragen dan de typen I tot IV."
citableSummary: "Het standaard huidbereik van IPL loopt van Fitzpatrick-type I tot type IV, die met standaardinstellingen werken. Type V is bruikbaar, maar alleen op het laagste energieniveau en alleen na een patchtest, omdat meer epidermale melanine een smallere veiligheidsmarge overlaat. Type VI is waar standaard-IPL stopt: de melanineabsorptie is niet meer te beheersen. De schaal begon in 1972 met drie huidtypen en werd in 1988 uitgebreid naar zes. IPL zendt breedbandlicht van 500 tot 1200 nm uit, terwijl Nd:YAG-lasers van 1064 nm een donkere huid beter verdragen."
pubDate: "2026-06-08"
...
De eerste beslissing over aan wie een IPL-ontharingsapparaat kan worden verkocht, is het Fitzpatrick-huidtype. Draai standaardinstellingen op een klant met huidtype VI en het resultaat is brandwonden, hyperpigmentatie en in ernstige gevallen onomkeerbare huidschade. Type V ligt dicht bij die grens: hij is bruikbaar, maar alleen op het laagste energieniveau en alleen na een patchtest. Die grens wordt bepaald door fotobiologie; de enige taak van de fabrikant is om de conclusie duidelijk te markeren.

## Waar het veilige bereik werkelijk eindigt

De Fitzpatrick-schaal deelt de huid in zes typen in op basis van de reactie op verbranding door de zon en bruinen. Het standaardbereik van IPL loopt van type I tot type IV. Type V is werkbaar, maar alleen op het laagste energieniveau en alleen na een patchtest. Type VI is het type dat afvalt, omdat het risico op thermisch letsel te hoog blijft, hoe de parameters ook worden afgesteld.
...
| Type IV | Olijf / lichtbruin | Verbrandt zelden, bruint gemakkelijk | Ja |
| Type V | Bruin | Verbrandt zelden, bruint duidelijk zichtbaar | Alleen laagste niveaus, met een patchtest |
| Type VI | Donkerbruin / zwart | Verbrandt nooit, bruint het diepst | Nee |

Lees de tabel volledig, want de onderste rijen zijn niet hetzelfde soort antwoord. Type I tot IV werken met standaardinstellingen. Type V maakt de marge nog smaller: ga naar het laagste energieniveau en doe een patchtest vóór een volledige sessie. Type VI is een nee, omdat de melaninedichtheid het punt heeft bereikt waarop lichtabsorptie niet meer door een standaardapparaat kan worden gecontroleerd.
...
Typen I tot IV kunnen op een standaardapparaat worden gebruikt, met passende parameters en veiligheidsfuncties. Typen I en II zijn meestal de beste kandidaten: hoog contrast, minder epidermale melanine. Type III is over het algemeen prima met conservatieve parameterselectie. Type IV staat bovenaan die groep: houd fluence en pulsduur conservatief en zorg voor grondige koeling.

Type V is de rij die mensen verkeerd lezen. Hij is bruikbaar, maar alleen op het laagste energieniveau en alleen na een patchtest — nooit met de instellingen van type IV. Reken op lagere fluence, langere pulsduren en agressievere koeling. In de praktijk betekent dat: ofwel een professional stelt het protocol in, ofwel het apparaat zelf houdt de energie laag via huidtintdetectie. Een type V-klant die dezelfde preset krijgt als een type II-klant is precies het scenario waarin pigmentschade ontstaat.

Type VI wordt afgeraden; de risico's concentreren zich in pigmentveranderingen, blaren en littekens.

Voor langdurige haarverwijdering op een donkere huid is het golflengteverschil wat de grens bepaalt. Diodelasers, meestal 800–810 nm, met langere pulsduren. En Nd:YAG-lasers op 1064 nm, in de klinische praktijk algemeen beschouwd als de veiligste keuze voor de donkerste huidtypen. Beide gebruiken langere golflengten die dieper doordringen, en epidermale melanine absorbeert daarvan veel minder dan van de kortere golflengten in het IPL-spectrum.

## Twee checklists: één voor consumenten, één voor merken

Voor consumenten: ontdek uw Fitzpatrick-type voordat u IPL gebruikt. Type I tot IV kunnen een thuisapparaat gebruiken volgens de handleiding. Bent u type V? Ga naar het laagste energieniveau, doe eerst een patchtest en behandel IPL dan als een behandeling die u plant in plaats van een routine die u zomaar start. Bent u type VI? Dan is IPL niet geschikt. Wanneer u "veilig voor alle huidtinten" ziet, vraag dan om het bewijs.
