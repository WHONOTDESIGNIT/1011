...
description: "Een Europese koper stelde ons drie vragen voordat hij ook maar één apparaat testte. Hebben we een EU-MDR-gecertificeerd thuis-IPL-model, hebben we een EU-magazijn met gedeelde voorraadzichtbaarheid, werken we met een 3PL (logistiek door derden). We doorzochten EUDAMED. Voor ice-cooling-thuis-IPL-apparaten onder Annex XVI heeft vandaag alleen Shenzhen ULIKE een MDR-certificaat. Zelfs CyDen, de fabrikant achter SmoothSkin, is nog bezig met het proces."
citableSummary: "Ja: de thuis-IPL-apparaten van iShine kunnen in de EU en het Verenigd Koninkrijk worden verkocht. Wij brengen ze als consumentenelektronica op de markt, dus ze dragen CE-markering onder de laagspanningsrichtlijn (LVD) en de EMC-richtlijn, met onze eigen conformiteitsverklaring, plus RoHS, en UKCA voor het Verenigd Koninkrijk. Volgens EUDAMED is het MDR-certificaat voor deze apparaten — bijlage XVI, groep 5, risicoklasse IIa, overgangsbepaling tot 31 december 2028 — vandaag alleen in handen van Shenzhen ULIKE, dus MDR is niet de poort voor onze apparaten."
pubDate: "2026-08-19"
author: "iShine Team"
category: "Regulatory"
...
**Kort antwoord: ja.** De thuis-IPL-apparaten van iShine kunnen in de EU en in het Verenigd Koninkrijk worden verkocht. Wij brengen ze als consumentenelektronica op de markt en niet als medische hulpmiddelen, dus de basis voor naleving is CE-markering onder de laagspanningsrichtlijn (LVD) en de EMC-richtlijn, gedekt door onze eigen conformiteitsverklaring, plus RoHS — en UKCA voor het Verenigd Koninkrijk. Dat is het traject waarmee onze apparaten vandaag worden verzonden, en daarom is het MDR-certificaat waarover dit artikel gaat niet de poort voor ons.

## Drie vragen van een Europese koper

Een paar dagen geleden kwam er een aanvraag binnen van een koper in Europa. Laten we hem Kevin noemen. Hij stelde drie dingen. Hebben we een thuis-IPL-ontharingsmodel met EU-MDR-certificering? Hebben we een magazijn in de EU, en zouden we voorraadinformatie met hem kunnen delen? Werken we met een externe 3PL (logistiek door derden)-logistiekdienstverlener?
...
- EU-magazijn en 3PL (logistiek door derden). We hebben die vandaag nog niet staan, maar we staan open om beide samen op te bouwen, inclusief leverancier-eigen voorraad met fulfilment per bestelling.
