...
export default defineConfig({
  ...
  // 构建后转换（foo/index.html → foo.html），并生成 dist/_redirects：
  // Netlify 不会自动把 /about 映射到 about.html，需显式 rewrite 规则
  // （/about → /about.html 200；/about/ → /about 301）。
  ...
  i18n: {
    defaultLocale: 'en',
    // 西班牙语：URL 前缀 /es/，hreflang 输出 es-ES
    locales: [
      'en',
      'tr',
      'ro',
