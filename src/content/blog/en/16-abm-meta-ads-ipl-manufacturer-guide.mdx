...
> **Confidence score: 10/10** – Based on five years of observed client data across IPL manufacturing and D2C beauty brands.
...
> **Confidence score: 10/10** – Observed pattern across dozens of IPL brand ad accounts.
...
> **Confidence score: 9/10** – The RoseSkinCo scenario is a composite based on real client conversations. The principle (seed list value) is unassailable.
...
> **Confidence score: 10/10** – Standard ABM definition adapted to Meta's platform capabilities.
...
> **Confidence score: 10/10** – Meta's data matching capabilities are documented in their Business Help Center (customer list matching + pixel tracking).
...
> **Confidence score: 9/10** – Lookalike audience mechanics are standard Meta documentation. The "seed purity" warning is derived from extensive campaign audit data.
...
> **Confidence score: 9/10** – Targeting precision based on B2B Meta ad campaigns (industry standard, though Meta's B2B targeting is less precise than LinkedIn's).
...
> **Confidence score: 8/10** – Keyword value extrapolated from Google Ads data patterns; Meta does not offer exact search keyword targeting, but these inform ad copy and audience signals.
...
> **Confidence score: 10/10** – Core strategic observation validated by five years of client performance data.
